...
def asn1_node_is_child_of(ix, jx):
	ixs,ixf,ixl = ix
	jxs,jxf,jxl = jx
...
def asn1_get_value_of_type(der, ix ,asn1_type):
	ixs,ixf,ixl = ix
	asn1_type_table = {
...
# get value
def asn1_get_value(der, ix):
	ixs,ixf,ixl = ix
	return der[ixf:ixl+1]

# get type+length+value
def asn1_get_all(der, ix):
	ixs,ixf,ixl = ix
